[2:35 pm, 08/09/2022] Sai: #include <stdio.h>
#include <netdb.h>
...
[2:35 pm, 08/09/2022] Sai: server
[2:35 pm, 08/09/2022] Sai: #include <netdb.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <sys/socket.h>
...
int main()
{
	...
	// assign IP, PORT
	servaddr.sin_family = AF_INET;
	servaddr.sin_addr.s_addr = inet_addr("192.168.112.128");
	servaddr.sin_port = htons(PORT);
